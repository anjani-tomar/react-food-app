        ...
        <div className="container">
          <div className="row clearfix">
                    ...
                    <div className="newsletter-form">
                      <form method="post"  action="/">
                        <div className="form-group">
                          ...
                          <button className="theme-btn btn-style-one clearfix" type="submit">
                          <span className="btn-wrap"><span className="text-one">subscribe</span><span className="text-two">subscribe</span></span>
                          </button>
                        </div>
                      </form>
                    </div>
            ...
            <div className="footer-col links-col last col-lg-3 col-md-6 col-sm-12">
              ...
              >
                <ul class="links"><li> <a href="https://www.facebook.com">facebook</a></li><li> <a href="https://www.instagram.com">instagram</a></li><li> <a href="https://twitter.com">Twitter</a></li><li> <a href="https://www.youtube.com">Youtube</a></li><li> <a href="https://www.google.com/maps">Google map</a></li></ul>
