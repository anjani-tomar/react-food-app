...
import { bg5, bg6, logo1, menumg1, menumg2, menumg3, menumg4, menumg5, menumg6 } from '../assets';
...
const MenuSection = () => {
  ...
  return (
    <section className='menu-section'>
      <div className="left-bg"><img src={bg5}/>  </div>
      <div className="right-bg"><img src={bg6}/>  </div>
      ...
      <div className="title-box centered">
        ...
        <div className='tabs-box menu-tabs'>
          ...
          <div className='tabs-content'>
            {showData === 0 && ( // Show content only when showData is 0
             <div id='tab-1'>
                ...
                <div className='menu-col col-lg-6 col-md-12 col-sm-12'>
                  <div className='inner'>
                    ...
                    <div className='inner-box'>
                      ...
                      <div class="text desc">
                        <a href="#">Tomatoes, green bell pepper, sliced cucumber onion, olives, and feta cheese. </a>
                      </div>
                    </div>
                    </div>
                    <div className='dish-block'>
                    <div className='inner-box'>
                      ...
                      <div class="title clearfix">
                        <div class="ttl clearfix">
                          <h5><a href="#">Greek Salad<span class="s-info">SEASONAL</span></a></h5>
                        </div>
                        <div class="price">
                          <span>$25.50</span>
                        </div>
                ...
                <div className='menu-col col-lg-6 col-md-12 col-sm-12'>
                  ...
                  <div className='dish-block'>
                    <div className='inner-box'>
                      ...
                      <div class="title clearfix">
                        <div class="ttl clearfix">
                          <h5><a href="#">Greek Salad<span class="s-info">NEW</span></a></h5>
                        </div>
                        <div class="price">
                          <span>$25.50</span>
                        </div>
            ...
            {showData === 1 && ( // Show content only when showData is 1
              <div id='tab-2'>
                <div className='row clearfix'>
                <div className='menu-col col-lg-6 col-md-12 col-sm-12'>
                  <div className='inner'>
